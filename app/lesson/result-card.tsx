  ...
  return (
    <div
      className={cn(
        ...
        variant === "acertos" && "border-green-500 bg-green-500"
      )}
    >
      <div
        className={cn(
          ...
          variant === "acertos" && "bg-green-500"
        )}
      >
        {variant === "acertos" ? "Acertos" : "Total XP"}
      </div>
      ...
      <div
        className={cn(
          ...
          variant === "acertos" && "text-green-500"
        )}
      >
        <Image
          src={imageSrc}
